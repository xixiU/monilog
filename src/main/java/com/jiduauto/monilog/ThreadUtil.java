...
class ThreadUtil {
    ...
    private final static Set<String> DEFAULT_EXCLUDE_PKGS = Sets.newHashSet("com.sun.proxy.$Proxy", "java", "sun.reflect", "org.springframework", "org.apache", "com.jiduauto.monilog", "com.jiduauto.javakit");
    /**
