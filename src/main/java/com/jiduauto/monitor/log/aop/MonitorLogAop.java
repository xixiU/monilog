...
public class MonitorLogAop {
    @Around("@within(com.jiduauto.monitor.log.annotation.MonitorLog) || @annotation(com.jiduauto.monitor.log.annotation.MonitorLog) || @target(com.jiduauto.monitor.log.annotation.MonitorLog)")
