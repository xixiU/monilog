    ...
    static class RocketMQConsumerInterceptor implements BeanPostProcessor {
        ...
        public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
            if (bean instanceof MQConsumer) {//不使用rocketmq-starter时
                ...
                if (originListener instanceof RocketMQConsumerInterceptor.EnhancedListenerConcurrently || originListener instanceof RocketMQConsumerInterceptor.EnhancedListenerOrderly) {
                    return bean;
                }
                container.setRocketMQListener(new RocketMQConsumerInterceptor.EnhancedRocketMqListener<>(bizListener, bizListener.getClass(), consumer.getConsumerGroup()));
            }
            return bean;
        }
    ...
    static class RocketMQProducerInterceptor implements BeanPostProcessor {
        ...
        public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
            if (bean instanceof DefaultMQProducer) {
                ...
                producer.getDefaultMQProducerImpl().registerSendMessageHook(new RocketMQProducerInterceptor.RocketMQSendHook());
            }
            return bean;
        }
